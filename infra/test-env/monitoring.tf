...
resource "aws_config_config_rule" "iam_password_policy" {
  name = "transilience-iam-password-policy"
...
resource "aws_config_config_rule" "root_mfa" {
  name = "transilience-root-account-mfa-enabled"
...
resource "aws_config_config_rule" "mfa_enabled" {
  name = "transilience-mfa-enabled-for-iam-console-access"
...
resource "aws_config_config_rule" "no_user_policies" {
  name = "transilience-iam-user-no-policies-check"
...
resource "aws_config_config_rule" "access_key_rotation" {
  name = "transilience-access-keys-rotated"
...
resource "aws_config_config_rule" "restricted_ssh" {
  name = "transilience-restricted-ssh"
...
resource "aws_config_config_rule" "vpc_flow_logs" {
  name = "transilience-vpc-flow-logs-enabled"
...
resource "aws_config_config_rule" "s3_encryption" {
  name = "transilience-s3-default-encryption-kms"
...
resource "aws_config_config_rule" "s3_public_access" {
  name = "transilience-s3-bucket-public-read-prohibited"
...
resource "aws_config_config_rule" "s3_ssl" {
  name = "transilience-s3-bucket-ssl-requests-only"
...
resource "aws_config_config_rule" "cloudtrail_enabled" {
  name = "transilience-cloud-trail-enabled"
...
resource "aws_config_config_rule" "guardduty_enabled" {
  name = "transilience-guardduty-enabled-centralized"
...
resource "aws_sns_topic" "compliance_alerts" {
  name = "transilience-compliance-alerts"
}
...
resource "aws_cloudwatch_event_rule" "root_login" {
  name        = "transilience-root-account-usage"
...
resource "aws_cloudwatch_event_rule" "sg_changes" {
  name        = "transilience-security-group-changes"
...
resource "aws_cloudwatch_event_rule" "iam_changes" {
  name        = "transilience-iam-policy-changes"
...
resource "aws_cloudwatch_event_rule" "s3_changes" {
  name        = "transilience-s3-policy-changes"
...
resource "aws_cloudwatch_event_rule" "config_compliance_change" {
  name        = "transilience-config-compliance-change"
...
resource "aws_cloudwatch_event_rule" "guardduty_findings" {
  name        = "transilience-guardduty-findings"
...
resource "aws_iam_role" "alert_lambda" {
  name = "transilience-alert-lambda-role"
...
resource "aws_lambda_function" "alert_forwarder" {
  ...
  function_name    = "transilience-alert-forwarder"
  ...
  tags = { Name = "transilience-alert-forwarder" }
}
