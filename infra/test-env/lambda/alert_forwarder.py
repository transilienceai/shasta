"""Transilience Alert Forwarder Lambda.
            ...
            "blocks": [
                {
                    ...
                    "text": {
                        "type": "plain_text",
                        "text": f"{emoji} Transilience: {alert['title']}",
                    }
                },
                {
                    "type": "section",
...
def create_jira_ticket(alert):
    ...
    payload = {
        "fields": {
            ...
            "summary": f"[Transilience] {alert['title']}",
            "description": {
                "type": "doc",
                "version": 1,
                "content": [{
            ...
            "issuetype": {"name": "Bug"},
            "labels": ["transilience", "compliance", f"soc2", severity],
        }
    }
