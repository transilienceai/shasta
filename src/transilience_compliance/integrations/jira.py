...
class JiraClient:
    ...
    def create_finding_ticket(self, finding: Finding) -> JiraTicket:
        ...
        payload = {
            "fields": {
                ...
                "issuetype": {"name": "Bug"},
                "labels": ["transilience-compliance", "compliance", "soc2", finding.severity.value, finding.domain.value],
            }
        }
    ...
    def search_existing_tickets(self, label: str = "transilience-compliance") -> list[dict]:
        """Search for existing compliance tickets."""
