...
Maps existing AWS checks to ISO 27001:2022 Annex A controls.
...
ISO27001_CONTROLS: dict[str, ISO27001Control] = {
    ...
    "A.5.23": ISO27001Control(
        ...
        guidance="This is the catch-all cloud security control. Your full compliance scan covers this comprehensively.",
