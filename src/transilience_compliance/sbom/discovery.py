...
def save_sbom(report: SBOMReport, output_path: Path | str = "data/sbom") -> Path:
    ...
    cyclonedx = {
        "bomFormat": "CycloneDX",
        "specVersion": "1.5",
        "serialNumber": f"urn:transilience-compliance:{report.account_id}:{timestamp}",
        "version": 1,
        "metadata": {
            "timestamp": report.generated_at,
            "tools": [{"vendor": "Transilience AI", "name": "Transilience Compliance SBOM Scanner", "version": "0.1.0"}],
            "component": {
                "type": "application",
        ...
        "components": [
            {
                ...
                "purl": dep.purl,
                "properties": [
                    {"name": "transilience:ecosystem", "value": dep.ecosystem},
                    {"name": "transilience:source", "value": dep.source},
                ],
            }
            for dep in report.dependencies
        ],
        "vulnerabilities": [
            {
                ...
                "properties": [
                    {"name": "transilience:package", "value": alert["package"]},
                    {"name": "transilience:version", "value": alert["version"]},
                    {"name": "transilience:source", "value": alert["source"]},
                ],
            }
