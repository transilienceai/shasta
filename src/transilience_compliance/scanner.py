"""Compliance scanner orchestration for Transilience Community Compliance."""

from __future__ import annotations

from transilience_compliance.aws.client import AWSClient
from transilience_compliance.aws.encryption import run_all_encryption_checks
from transilience_compliance.aws.iam import run_all_iam_checks
from transilience_compliance.aws.logging_checks import run_all_logging_checks
from transilience_compliance.aws.networking import run_all_networking_checks
from transilience_compliance.aws.storage import run_all_storage_checks
from transilience_compliance.aws.vulnerabilities import run_all_vulnerability_checks
from transilience_compliance.compliance.mapper import enrich_findings_with_controls
from transilience_compliance.evidence.models import CheckDomain, Finding, ScanResult
...
def run_full_scan(
    ...
    if include_github and github_token and github_repos:
        from transilience_compliance.integrations.github import run_github_checks
    ...
    if framework in ("iso27001", "both"):
        from transilience_compliance.compliance.iso27001_mapper import enrich_findings_with_iso27001
