...
TOOL_SCHEMAS: list[dict[str, Any]] = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "status": {
                    "type": "string",
                    "enum": ["pass", "fail", "partial", "not_assessed", "not_applicable"],
                },
                "domain": {
                    "type": "string",
                    "enum": [
                ...
                "control_id": {
                    "type": "string",
                    "description": "e.g., CC6.1 — only meaningful with framework set",
                },
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "framework": {
                    "type": "string",
                    "enum": ["soc2", "iso27001", "hipaa", "iso42001", "eu_ai_act", "ai_governance"],
                }
            },
            "required": ["framework"],
            "additionalProperties": False,
    ...
    {
        "type": "function",
        "name": "get_multi_framework_score",
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "account_id": {
                    "type": "string",
                    "description": "Cloud account ID — pass the user's account from latest scan if unknown",
                },
                "status": {
                    "type": "string",
                    "enum": ["open", "in_progress", "accepted", "resolved"],
                },
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "related_finding": {
                    "type": "string",
                    "description": "Optional finding ID this risk relates to",
                },
            },
            "required": [
                "account_id",
